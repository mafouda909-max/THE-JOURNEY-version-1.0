...
export const offers = pgTable(
  "offers",
  {
    ...
    priceType: varchar("price_type", { length: 16 })
      .notNull()
      .default("per_person"), // per_person | per_group | starting_from
    ...
    status: varchar("status", { length: 20 })
      .notNull()
      .default("pending_review"), // draft | pending_review | published | expired | rejected | archived
...
export const contactRequests = pgTable(
  "contact_requests",
  {
    ...
    travelerAccountId: integer("traveler_account_id").references(
      () => accounts.id,
      { onDelete: "set null" },
    ),
...
export const verificationChallenges = pgTable(
  ...
  (t) => [
    index("verification_challenges_account_idx").on(t.accountId, t.createdAt),
  ],
);
...
export const travelFacts = pgTable(
  "travel_facts",
  {
    ...
    sourceType: varchar("source_type", { length: 32 })
      .notNull()
      .default("AGENT_REPORTED"), // OFFICIAL_GOVERNMENT | AIRLINE_SUPPLIER | VERIFIED | SOURCE_REPORTED | AGENT_REPORTED | AI_INFERRED
    ...
    freshnessStatus: varchar("freshness_status", { length: 16 })
      .notNull()
      .default("UNKNOWN"), // FRESH | AGING | STALE | EXPIRED | UNKNOWN | CONFLICTED
